package com.wein_business.ui.controls.qr
...
class ViewFinderOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val boxPaint: Paint = Paint().apply {
        ...
        strokeWidth = context.resources.getDimensionPixelOffset(R.dimen.dimen_5).toFloat()
    }
    ...
    private val boxCornerRadius: Float =
        context.resources.getDimensionPixelOffset(R.dimen.dimen_10).toFloat()
